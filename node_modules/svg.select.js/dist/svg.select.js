...
SelectHandler.prototype.init = function (value, options) {
    ...
    // ------------ start
    var elMatrix = this.getMatrixTheOldVersion(this.el)

    this.nested.matrix(elMatrix.translate(bbox.x, bbox.y))
...
SelectHandler.prototype.getMatrixTheOldVersion = function(svgNode) {
    var abcdef = 'abcdef'.split('')
    var elMatrix = new svg_js.Matrix(svgNode)

    var matrix = this.el.parent().node.createSVGMatrix()

    for (var i = abcdef.length - 1; i >= 0; i--) {
        matrix[abcdef[i]] = elMatrix[abcdef[i]]
    }
...
svg_js.Element.prototype.selectize.defaults = {
