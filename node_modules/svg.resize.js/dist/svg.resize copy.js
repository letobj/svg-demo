...
"use strict";
    ...
    ResizeHandler.prototype.resize = function (event) {
        ...
        this.parameters = {
            ...
            // --------- lmj
            rotation: (this.el.transform().rotation) ?? ( this.el.transform().rotate)  // The current rotation of the element
        };
        console.log('this.parameters.p :>> ', this.parameters.p);
