...
;(function(svg_js) {
    ...
    ;(function () {
        ...
        function ResizeHandler(el) {
            ...
            this.p = el.doc ? el.doc().node.createSVGPoint() : el.root().node.createSVGPoint();
        }
        ...
        ResizeHandler.prototype.resize = function (event) {
            ...
            this.parameters = {
                ...
                rotation: this.el.transform().rotation || this.el.transform().rotate || 0  // The current rotation of the element
            };
            ...
            switch (event.type) {
                ...
                case 'rot':
                    ...
                    this.calc = function (diffX, diffY) {
                        ...
                        var newAngle = angle - (angle % this.options.snapToAngle)
                        this.el
                        .center(this.parameters.box.cx, this.parameters.box.cy)
                        .transform({rotate: newAngle, rotation : newAngle, originX : this.parameters.box.cx, originY : this.parameters.box.cy})
            ...
            // Touches.
            svg_js.on(window, 'touchmove.resize', function(e) {
                _this.update(e || window.event);
            });
            svg_js.on(window, 'touchend.resize', function() {
                _this.done();
            });
            // Mouse.
            svg_js.on(window, 'mousemove.resize', function (e) {
                _this.update(e || window.event);
            });
            svg_js.on(window, 'mouseup.resize', function () {
                _this.done();
            });
        ...
        ResizeHandler.prototype.done = function () {
            this.lastUpdateCall = null;
            svg_js.off(window, 'mousemove.resize');
            svg_js.off(window, 'mouseup.resize');
            svg_js.off(window, 'touchmove.resize');
            svg_js.off(window, 'touchend.resize');
        ...
        svg_js.Element.prototype.resize.defaults = {
